...
void frame(void)
{
    ...
    clearline();
    //дл€ выравнивани€ €ркости 1 строки
...
void clearline()
// ќчистка горизонтального сдвига. ≈сли его не очистить,
// то накопленный в нем паразитный зар€д будет добавлен в первую строку изображени€
...
void clearframe(void)
// ќчистка сдвигового регистра. ≈сли его не очистить,
// то накопленный в нем зар€д будет добавлен в изображение.
// ќчищаетс€ весь регистр вместе с "темными" и неиспользуемыми строками.
// ќпераци€ проводитс€ перед "сливом" изображени€ в сдвиговый регистр.
